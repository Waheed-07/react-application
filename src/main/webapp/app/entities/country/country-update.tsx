  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="investorRiskReturnProfilingApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="investorRiskReturnProfilingApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('investorRiskReturnProfilingApp.country.name')}
                id="country-name"
                name="name"
                data-cy="name"
                type="text"
