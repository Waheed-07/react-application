...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="investorRiskReturnProfilingApp.country.delete.question">
        <Translate contentKey="investorRiskReturnProfilingApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
