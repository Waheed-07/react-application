...
import { deleteEntity, getEntity } from './personal-details.reducer';
...
export const PersonalDetailsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="investorRiskReturnProfilingApp.personalDetails.delete.question">
        <Translate
          contentKey="investorRiskReturnProfilingApp.personalDetails.delete.question"
          interpolate={{ id: personalDetailsEntity.id }}
        >
